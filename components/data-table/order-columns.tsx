          ...
          <DropdownMenuContent align="end">
            ...
            {order.status !== "COMPLETED" && order.status !== "CANCELLED" && (
              <>
                {/* <DropdownMenuItem
                  onClick={() =>
                    onUpdateStatus(order.id.toString(), "COMPLETED")
                  }
                >
                  Mark as Completed
                </DropdownMenuItem> */}
                <DropdownMenuItem
                  onClick={() =>
                    onUpdateStatus(order.id.toString(), "CANCELLED")
                  }
                >
                  Mark as Cancelled
                </DropdownMenuItem>
                <DropdownMenuItem
                  onClick={() =>
                    router.push(
                      `/dashboard/bar/manager/catalog?orders=${order.id.toString()}`
                    )
                  }
                >
                  Edit this Order
            ...
            {/* {order.status === "COMPLETED" && (
              <DropdownMenuItem
                onClick={() =>
                  OnPrintReceipt ? OnPrintReceipt(order.id.toString()) : {}
                }
