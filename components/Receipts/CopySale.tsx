...
const CopySale: React.FC<ReceiptProps> = ({ receiptData }) => {
  const {
    tradeName,
    address,
    tin,
  ...
  return (
    ...
    >
      ...
      <div
        style={{ fontSize: "14px", fontWeight: "bold", textAlign: "center", margin: "1mm" }}
      >
        COPY
      </div>
      ...
      {/* QR Code */}
      <div
        style={{ display: "flex", justifyContent: "center", margin: "2mm 0" }}
      >
        <QRCode
